...
@@@@martaA: yo pondría q se ha hecho vía Pymol y si has usado algún código para hacerlo lo incluiría. y sino poner directamente que vía Pymol y punx
...
# Colorear modelos
color darkblue, (Osm1_quarternarystate_PTMs and b > 90)

# Color para Confianza Alta (70 a 90)
color lightblue, (Osm1_quarternarystate_PTMs and b > 70 and b <= 90)

# Color para Confianza Media (50 a 70)
color yellow, (Osm1_quarternarystate_PTMs and b > 50 and b <= 70)

# Color para Baja Confianza (< 50)
color orange, (Osm1_quarternarystate_PTMs and b <= 50)


select motif_quarternarystate_PTM_TGY, Osm1_quarternarystate_PTMs and resi 171+173
show sticks, motif_quarternarystate_PTM_TGY
color lightgreen, motif_quarternarystate_PTM_TGY
show spheres, (motif_quarternarystate_PTM_TGY and name P)
set sphere_scale, 0.3, (motif_quarternarystate_PTM_TGY and name P)
